...
|---|---|---|
| GoalBasedAllocation 0.3.1 | analytical continuous-time MV policy, absorbing wealth floor, terminal distribution under two-regime jumps | the research question is survival, floor risk, glide paths, or mandate distributions under this published model |
